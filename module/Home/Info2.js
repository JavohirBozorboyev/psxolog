...
const Info2 = () => {
  return (
    <div className=" py-6">
      <div
        className="container mx-auto p-3  bg-cover bg-center rounded-md min-h-[300px] flex justify-center flex-col items-center bg-gradient-to-tr from-slate-700 to-slate-500"
        style={{
          background:
      ...
      >
        <h1 className="text-white text-2xl md:text-2xl font-bold md:w-1/2 text-center">
          Bizning hizmatlarimmizdan foydalanganizdan hursandmiz
        </h1>
        <p className="text-center mt-4 text-gray-50 text-lg md:text-xl">
